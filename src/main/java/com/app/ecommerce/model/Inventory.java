...
public class Inventory {
    ...
    public Inventory(Double unitPrice, Integer reorderLevel, Double wholesalePrice, Double partnerPrice, Double retailPrice, String shelfLocation, Integer moq, Integer units, Boolean reorderFlag, LocalDateTime lastEmailSent) {
